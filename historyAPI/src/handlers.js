    ...
    rest.get('/design', (req, res, ctx) => {
        return res(
            ...
            ctx.json([
                {
                    id: 12,
                    thumbnail: 'design12.png',
                    title: '거꾸로 입력하는 가입 화면, 처음에 어떻게 떠올렸을까?',
                    content:
                        '이 글은 토스증권 QA Team에 입사를 고려중인 지원자들을 위해 작성된 글입니다. ',
                    createDate: '2022,09,12',
                },
                {
                    id: 12,
                    thumbnail: 'design13.png',
